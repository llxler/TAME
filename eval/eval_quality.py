...
if __name__ == '__main__':
    ...
    dataname = 'shoppers' # TODO 修改数据集的名字
    model = 'tabddpm'
    ...
    if syn_data.shape != real_data.shape:
        real_data = real_data.iloc[:syn_data.shape[0], :]
    
    task_path = f'eval/result/{syn_path.split("/")[-1].split(".")[0]}.txt'
